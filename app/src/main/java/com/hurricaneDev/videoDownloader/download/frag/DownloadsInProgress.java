...
import com.hurricaneDev.videoDownloader.download.OnDownloadWithNewLinkListener;
...
import com.hurricaneDev.videoDownloader.download.Tracking;
        ...
        if (view == null) {
            ...
            downloadsStartPauseButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (Utils.isServiceRunning(DownloadManager.class, activity.getApplicationContext())) {
                        pauseDownload();
                    } else {
