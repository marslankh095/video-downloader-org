...
public abstract class VideoContentSearch extends Thread {
    ...
    public abstract void onVideoFound(String videoQuality,String size, String type, String link, String name,
    ...
    private void addVideoToList(URLConnection uCon, String page, String title, String contentType) {
        try {
            ...
            String quality = getVideoQuality();

            onVideoFound(quality, size, type, link, name, page, chunked, website, audio);
        } catch (IOException e) {
            //nada
        }
    }
    ...
    private String getVideoQuality() {
        ...
        try {
            if (url != null) {
                ...
                if (width == 640 && (height == 360 || height == 480)) {
                    quality = "SD";
                } else if (width == 1280) {
                    quality = "720p";
                } else if (width == 1920) {
        ...
        try {
            ...
            if (host.contains(TWITTER) || host.contains(METACAFE) || host.contains
                ...
                if (host.contains(TWITTER)) {
                    ...
                    type = "ts";
                    String quality = getVideoQuality();
                    onVideoFound(quality,null, type, link, name, page, true, website, audio);
